...
- Fix comments injected in AWS ACLs. (@michaelblyons, #105, #106)

---

## v2.0.2 - 2026-06-09

- Add highlighting for IP addresses if they take up a string's entire content. (@michaelblyons #89)
- Add `tfbackend` as a file extension for `tfvars`. (@michaelblyons, #101, #102)
- Fix comments not being highlighted in parentheses. (@michaelblyons, #103, #104)
- Scope hanging brackets in Plan syntax. (@michaelblyons, #100)
